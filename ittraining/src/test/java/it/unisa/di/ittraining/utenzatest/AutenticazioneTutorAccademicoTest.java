...
public class AutenticazioneTutorAccademicoTest {
  ...
  public void autenticazioneTutorAccademicoUsernameErrato() 
  ...
  public void autenticazioneTutorAccademicoPasswordErrata() 
      throws UsernameNonEsistenteException, PasswordErrataException {
    ...
    when(studentiRep.findByUsernameAndPassword(tutor.getUsername(), 
      tutor.getPassword())).thenReturn(null);
    when(aziendaleRep.findByUsernameAndPassword(tutor.getUsername(), 
      tutor.getPassword())).thenReturn(null);
    when(impiegatiRep.findByUsernameAndPassword(tutor.getUsername(), 
      tutor.getPassword())).thenReturn(null);
    when(accademicoRep.findByUsernameAndPassword(tutor.getUsername(), 
      tutor.getPassword())).thenReturn(null);
  ...
  public void autenticazioneTutorAccademicoConSuccesso() {
    ...
    when(impiegatiRep.findByUsernameAndPassword(tutor.getUsername(), 
      tutor.getPassword())).thenReturn(null);
    when(accademicoRep.findByUsernameAndPassword(tutor.getUsername(), 
      tutor.getPassword())).thenReturn(tutor);
