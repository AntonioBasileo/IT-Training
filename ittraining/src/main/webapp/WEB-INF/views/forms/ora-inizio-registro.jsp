...
<html>
		        ...
		        <div class="row">
		        	<p class="teal-text">Orario di inizio:</p>
		        	<div class="input-field col s3">
		        		<form:select path="oraInizio" class="icons" id="oraInizio${registro.id}">
		        	...
		        	<div class="input-field col s3">
		        		<form:select path="minutoInizio" class="icons" id="minutoInizio${registro.id}">
