...
public class RegistroFormValidator implements Validator {
	  ...
	  public void validate(Object target, Errors errors) {
		  ...
		  try {
			  if(form.getAnno() == null || form.getMese() == null || form.getGiorno() == null ||
					  form.getAnnoInizio() == null || form.getMeseInizio() ==  null || form.getGiornoInizio() == null
					  || form.getAnnoFine() == null || form.getMeseFine() == null || form.getGiornoFine() == null)
				  throw new DataRegistroNonValidaException("Il campo di qualche data non è stato compilato come dovuto");
		  ...
		  try {
			  if(form.getOraInizio() == null || form.getMinutoInizio() == null 
				  ...
				  throw new OrarioNonValidoException("Alcuni campi degli orari non sono stati compilati correttamente");
