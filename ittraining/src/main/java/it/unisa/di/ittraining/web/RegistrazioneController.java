...
public class RegistrazioneController {
  ...
  */
  ...
  public String elaboraRichiestaIscrizioneStudente(@ModelAttribute("registrazioneStudente") 
      RegistrazioneStudenteForm registrazioneStudente, Model model, BindingResult result, 
      RedirectAttributes redirectAttributes) throws PasswordNonValidaException, 
      PasswordNonCorrispondentiException, NomeNonValidoException, NomeCognomeTroppoLungoException,
  ...
  */
  @RequestMapping(value = 
         ...
         method = RequestMethod.POST)
  public String elaboraRichiestaIscrizioneSegreteria(HttpSession session, 
         @ModelAttribute("registrazioneSegreteria") RegistrazioneForm registrazioneSegreteria, 
         ...
         DataDiNascitaNonValidaException, UsernameNonValidoException, UsernameEsistenteException,
    ...
    if (result.hasErrors()) {
      redirectAttributes
           ...
           + ".registrazioneSegreteria", result);
  ...
  */
  ...
  public String elaboraRichieicostaIscrizioneTutorAccademico(HttpSession session, 
      @ModelAttribute("registrazioneAccademico") RegistrazioneForm registrazioneAccademico, 
      Model model, BindingResult result, RedirectAttributes redirectAttributes) 
      throws PasswordNonValidaException, PasswordNonCorrispondentiException, NomeNonValidoException,
  ...
  */
  ...
  public String elaboraRichiestaIscrizioneTutorAziendale(HttpSession session, 
      @ModelAttribute("registrazioneAziendale") RegistrazioneAziendaleForm registrazioneAziendale, 
      Model model, BindingResult result, RedirectAttributes redirectAttributes) throws 
      PasswordNonValidaException, PasswordNonCorrispondentiException, AziendaNonValidaException,
      ...
      NomeNonValidoException, NomeCognomeTroppoLungoException, NomeCognomeTroppoCortoException, 
      CognomeNonValidoException, EmailNonAssociataException, UsernameNonValidoException, 
      UsernameEsistenteException, DataDiNascitaNonValidaException, SessoNonValidoException,
